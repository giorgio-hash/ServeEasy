...
Analogalmente, sempre grazie all'annotazione \texttt{@Autowired}, anche il livello Interface comunicherà verso il dominio attraverso una porta, senza sapere \textit{chi sta offrendo} le funzionalità.
